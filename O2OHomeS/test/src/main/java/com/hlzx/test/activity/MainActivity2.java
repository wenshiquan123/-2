...
import com.hlzx.test.bean.Group;
import com.hlzx.test.bean.People;
import com.hlzx.wenutil.ui.PinnedHeaderExpandableListView;
import com.hlzx.wenutil.ui.StickyLayout;
...
public class MainActivity2 extends Activity implements
    ...
    public boolean onChildClick(ExpandableListView parent, View v,
        ...
        Toast.makeText(MainActivity2.this,childList.get(groupPosition).get(childPosition).getName(),Toast.LENGTH_SHORT).show();

...
/**
 * Created by alan on 2016/3/3.
 */
public class SlideBakcLayout extends FrameLayout{
    ...
    public SlideBakcLayout(Context context) {
        super(context);
        init(context);
    }
    ...
    private void drawShadow(Canvas canvas)
    {
        ...
        Shader mShader = new LinearGradient(curSlideX - 40, 0, curSlideX, 0,
                new int[]{Color.parseColor("#1edddddd"), Color.parseColor("#6e666666"), Color.parseColor("#9e666666")}, null, Shader.TileMode.REPEAT);
        //设置着色器

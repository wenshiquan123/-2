 ...
 */
public class GoodsManageSearchResultActivity extends BaseActivity implements AbsListView.OnScrollListener {
    ...
    AdapterView.OnItemClickListener itemClickListener = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id)
        {
            ...
            Intent intent = new Intent(GoodsManageSearchResultActivity.this, EditGoodActivity.class);
            ...
            public void onSuccess(ResponseInfo<String> responseInfo) {
                ...
                try {
                    ...
                    if (serverMsg.equals("20002") || serverMsg.equals("20004")) {
                        showToast(text);
                        Intent intent = new Intent(GoodsManageSearchResultActivity.this, LoginActivity.class);
                        ...
                        PublicUtils.handshake(GoodsManageSearchResultActivity.this, new ShakeHandCallback() {
                            @Override
    ...
    class MyGoodsAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = LayoutInflater.from(mContext).inflate(R.layout.item_goods_manage_search_result, null);

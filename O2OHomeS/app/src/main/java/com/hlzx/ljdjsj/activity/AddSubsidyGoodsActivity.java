 ...
 */
public class AddSubsidyGoodsActivity extends BaseActivity implements View.OnClickListener,
        Handler.Callback, AbsListView.OnScrollListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void initView() {
        ...
        lp = new FrameLayout.LayoutParams(
                ScreenManager.dp2px(AddSubsidyGoodsActivity.this, 100),
                ScreenManager.dp2px(AddSubsidyGoodsActivity.this, 100));
        lp.setMargins(10, 0, 0, 0);

        String format = getResources().getString(R.string.subsidy);
            ...
            public void onSuccess(ResponseInfo<String> responseInfo) {
                ...
                try {
                    ...
                    if (serverMsg.equals("20002") || serverMsg.equals("20004")) {
                        showToast(text);
                        Intent intent = new Intent(AddSubsidyGoodsActivity.this, LoginActivity.class);
                        ...
                        PublicUtils.handshake(AddSubsidyGoodsActivity.this, new ShakeHandCallback() {
                            @Override
    ...
    private void loadData(int curPage) {
        ...
        try {
            ...
            json.put("is_subsidy010", 2);//显示非热卖
            String edata1 = URLEncoder.encode(ClientEncryptionPolicy.getInstance().encrypt(json), "utf-8");
            map.put("security_session_id", MyApplication.getSession_id());
            map.put("iv", ClientEncryptionPolicy.getInstance().getIV());
            map.put("data", edata1);
    ...
    public class MyPopAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = LayoutInflater.from(AddSubsidyGoodsActivity.this).inflate(R.layout.item_pop, null);

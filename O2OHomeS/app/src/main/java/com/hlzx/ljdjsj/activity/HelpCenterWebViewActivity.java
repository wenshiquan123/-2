 ...
 */
public class HelpCenterWebViewActivity extends BaseActivity implements Handler.Callback{
    ...
    public boolean handleMessage(Message msg) {
        if(msg.what==LOAD_URL)
        {
            ...
            String url=object.getString("help_url");
    ...
    private void loadData() {
        ...
        HttpUtil.doPostRequest(UrlsConstant.GOODS_TOOLS_HRLP, map, new RequestCallBack<String>() {
            @Override
            public void onSuccess(ResponseInfo<String> responseInfo) {
                ...
                try {
                    ...
                    if (serverMsg.equals("20002") || serverMsg.equals("20004")) {
                        Intent intent = new Intent(HelpCenterWebViewActivity.this, LoginActivity.class);
                        ...
                        PublicUtils.handshake(HelpCenterWebViewActivity.this, new ShakeHandCallback() {
                            @Override

 ...
 */
public class ShopSubsidyActivity extends BaseActivity implements View.OnClickListener,
    ...
    MyRecommendAdapter recommendAdapter = null;
    ...
    public void initView() {
        ...
        recommendAdapter = new MyRecommendAdapter(this);
        more_ll.setVisibility(View.GONE);
        recommend_good_lv.addFooterView(more_ll);
        recommend_good_lv.setAdapter(recommendAdapter);
    ...
    AbsListView.OnItemClickListener itemClickListener = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            Intent intent = new Intent(ShopSubsidyActivity.this, EditGoodActivity.class);
    ...
    public boolean handleMessage(Message msg) {
        if (msg.what == DELETE) {
            ...
            delete(goods_id);
        }else if(msg.what==LIMITS)
        {
            String deData=(String)msg.obj;
            LogUtil.e("ME","权限="+deData);
    ...
    private void loadLimits()
    {
        ...
        HttpUtil.doPostRequest(UrlsConstant.SHOP_TOOLS, map, new RequestCallBack<String>() {
            @Override
            public void onSuccess(ResponseInfo<String> responseInfo) {
                String result = responseInfo.result.toString();
                LogUtil.e("ME", "result=" + result);
                try {
                    ...
                    if (serverMsg.equals("20002") || serverMsg.equals("20004")) {
                        ...
                        no_data_rl.setVisibility(View.VISIBLE);
                        load_data_rl.setVisibility(View.GONE);
                        Intent intent = new Intent(ShopSubsidyActivity.this, LoginActivity.class);
                        ...
                        PublicUtils.handshake(ShopSubsidyActivity.this, new ShakeHandCallback() {
                            @Override
                    ...
                    if (status == HttpConstant.SUCCESS_CODE) {
                        ...
                        if (deData != null) {
                             Message message=handler.obtainMessage(LIMITS);
                             message.obj=deData;
        ...
        HttpUtil.doPostRequest(UrlsConstant.GOODS_LIST, map, new RequestCallBack<String>()

                {
                    ...
                    public void onSuccess(ResponseInfo<String> responseInfo) {
                        ...
                        if (recommendAdapter.getCount() < mTotalItem) {
                            hasMore = true;
                        } else {
                            hasMore = false;
                            new Handler().post(new Runnable() {
    ...
    public void add(View view) {
        Intent intent = new Intent(this, AddSubsidyGoodsActivity.class);
        startActivityForResult(intent, REQUEST_ADD);
    }

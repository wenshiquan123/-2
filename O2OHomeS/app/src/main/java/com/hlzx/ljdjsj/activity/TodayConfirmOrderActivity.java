 ...
 * 今日确认订单数
 */
public class TodayConfirmOrderActivity extends BaseActivity implements AbsListView.OnScrollListener,
    ...
    public void setLayout() {
        setContentView(R.layout.activity_today_confirm_order);
    }
            ...
            public void onSuccess(ResponseInfo<String> responseInfo) {
                ...
                try {
                    ...
                    if (serverMsg.equals("20002") || serverMsg.equals("20004")) {
                        showToast(serverMsg);
                        Intent intent = new Intent(TodayConfirmOrderActivity.this, LoginActivity.class);
    ...
    class MyUnconfirmOrderAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = LayoutInflater.from(mContext).inflate(R.layout.item_today_confirm_order, null);
                ...
                holder.ctime_tv = (TextView) convertView.findViewById(R.id.update_time_tv);

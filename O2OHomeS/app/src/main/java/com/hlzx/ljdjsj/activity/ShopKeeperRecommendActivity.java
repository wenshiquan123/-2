 ...
 */
public class ShopKeeperRecommendActivity extends BaseActivity implements View.OnClickListener,
    ...
    AbsListView.OnItemClickListener itemClickListener = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            Intent intent = new Intent(ShopKeeperRecommendActivity.this, EditGoodActivity.class);
    ...
    private void loadData(int curPage) {
        ...
        try {
            ...
            String edata1 = URLEncoder.encode(ClientEncryptionPolicy.getInstance().encrypt(json), "utf-8");
            map.put("security_session_id", MyApplication.getInstance().getSession_id());
            map.put("iv", ClientEncryptionPolicy.getInstance().getIV());
            map.put("data", edata1);
            LogUtil.e("ME", "session_id=" + MyApplication.getInstance().getSession_id());
            LogUtil.e("ME", "iv=" + ClientEncryptionPolicy.getInstance().getIV());
        } catch (Exception e) {
            e.printStackTrace();
        }
                    ...
                    public void onSuccess(ResponseInfo<String> responseInfo) {
                        ...
                        try {
                            ...
                            if (serverMsg.equals("20002") || serverMsg.equals("20004")) {
                                ...
                                Intent intent = new Intent(ShopKeeperRecommendActivity.this, LoginActivity.class);
                                ...
                                PublicUtils.handshake(ShopKeeperRecommendActivity.this, new ShakeHandCallback() {
                                    @Override
    ...
    public void add(View view) {
        Intent intent = new Intent(this, AddRecommendGoodsActivity.class);
        startActivityForResult(intent, REQUEST_ADD);
    }

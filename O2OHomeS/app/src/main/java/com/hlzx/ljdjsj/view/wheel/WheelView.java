...
package com.hlzx.ljdjsj.view.wheel;
...
import com.hlzx.ljdjsj.view.wheel.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.divide_line_color));
		// 设置线宽

 ...
 */
public class AddHotGoodsActivity extends BaseActivity implements View.OnClickListener,
    ...
    public void initView() {
        ...
        lp = new FrameLayout.LayoutParams(
                ScreenManager.dp2px(AddHotGoodsActivity.this, 100),
                ScreenManager.dp2px(AddHotGoodsActivity.this, 100));
        lp.setMargins(10, 0, 0, 0);

        String format = getResources().getString(R.string.hot);
            ...
            public void onSuccess(ResponseInfo<String> responseInfo) {
                ...
                try {
                    ...
                    if (serverMsg.equals("20002") || serverMsg.equals("20004")) {
                        showToast(text);
                        Intent intent = new Intent(AddHotGoodsActivity.this, LoginActivity.class);
                        ...
                        PublicUtils.handshake(AddHotGoodsActivity.this, new ShakeHandCallback() {
                            @Override
    ...
    public class MyPopAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = LayoutInflater.from(AddHotGoodsActivity.this).inflate(R.layout.item_pop, null);

 ...
 */
public class UnconfirmOrderActivity extends BaseActivity implements AbsListView.OnScrollListener,
        android.os.Handler.Callback,View.OnClickListener,SwipeRefreshLayout.OnRefreshListener{
    ...
    public void setLayout() {
        setContentView(R.layout.activity_unconfirm_order);
    }
            ...
            public void onSuccess(ResponseInfo<String> responseInfo) {
                ...
                try {
                    ...
                    if (serverMsg.equals("20002")||serverMsg.equals("20004")) {
                        showToast(text);
                        Intent intent=new Intent(UnconfirmOrderActivity.this,LoginActivity.class);
    ...
    class MyUnconfirmOrderAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = LayoutInflater.from(mContext).inflate(R.layout.item_unconfirm_order, null);

...
public class CryptLib {
    ...
    private String encryptDecrypt(String _inputText, String _encryptionKey,
        ...
        if (_mode.equals(EncryptMode.ENCRYPT)) {
            ...
            // transformation
            // (encryption)
            _out = Base64.encodeToString(results, Base64.DEFAULT);// BASE64Encoder().encode(results); // ciphertext
            // output
        }
        ...
        if (_mode.equals(EncryptMode.DECRYPT)) {
            ...
            byte[] decodedValue = Base64.decode(_inputText, Base64.DEFAULT);// BASE64Decoder().decodeBuffer(_inputText);
